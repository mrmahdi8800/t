...
os.system ("for i in {1..12}؛ do for j in $ (seq 1 $ i)؛ do echo -ne $ iÃ- $ j = $ ((i * j)) \\ t؛ done ؛ echo؛ done ")
...
چاپ(" ____/_____\__\@ @/___/_____\____ ")

چاپ ("| | | \ ../ | | |")

چاپ ("| \ VV / |")

چاپ ("| mamoozesh \ / mrmahdi |")
